export default class Card {
  ...
  _setLike() {
    if (this._isLiked) {
      this._handleLikeDelete(this._cardData._id, this._likeBtn, this._likeCounter)
        this._isLiked = false;
    } else {
      this._handleLikeClick(this._cardData._id, this._likeBtn, this._likeCounter)
        this._isLiked = true;
    }
  }
  ...
  _setEventListeners() {
    this._trashBtn.addEventListener("click", () => this._cardDeleteHandler(this._card, this._cardData._id));
